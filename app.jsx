// app.jsx — App shell, navigation, frame, tweaks

const { useState, useEffect, useRef } = React;

// Detect: are we running as a real installed PWA, or just previewed in browser?
// In standalone mode we drop the iOS device-frame chrome and let the OS handle it.
...
function App() {
  ...
  // Clear prev after transition duration so exiting screens unmount and free memory
  useEffect(() => {
    if (!prev) return;
