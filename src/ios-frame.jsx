...
export function IOSKeyboard({ dark = false }) {
  ...
  return (
    <div style={{
      ...
      boxShadow: dark ? '0 -2px 20px rgba(0,0,0,0.09)' : '0 -1px 6px rgba(0,0,0,0.018)',
    }}>
      <div style={{
      ...
      <div style={{
        ...
        {['"The"', 'the', 'to'].map((w, i) => (
          <React.Fragment key={i}>
            ...
            <div style={{
              flex: 1, textAlign: 'center', fontFamily: '-apple-system, system-ui',
              fontSize: 17, color: sugg, letterSpacing: -0.43, lineHeight: '22px',
            }}>{w}</div>
          </React.Fragment>
        ))}
      </div>
