...
const RECIPES = {
  t55: { name: 'T55 長棍', short: 'T55', water: 70, salt: 2, yeast: 1,
    flour: '麵粉（T55）',
    tips: ['室溫發酵：基礎發酵 1-2 小時至兩倍大，後發 1 小時', '冷藏發酵：混合後冷藏 12-16 小時，烤前回溫 1-2 小時', '底盤放水製造蒸氣，預熱 230-240°C 烘烤 20-25 分（表面脆皮金黃）'] },
  t65: { name: 'T65 鄉村', short: 'T65', water: 75, salt: 2.2, yeast: 0.8,
    flour: '麵粉（T65）',
    tips: ['室溫發酵：基礎發酵 2-3 小時至兩倍大，後發 1-2 小時', '冷藏發酵：混合後冷藏 16-24 小時，烤前回溫 1-2 小時，水合度高屬正常', '底盤放水製造蒸氣，預熱 220-230°C 烘烤 30-35 分（表面脆皮金黃）'] },
  focaccia: { name: '佛卡夏', short: 'Focaccia', water: 75, salt: 2, yeast: 1, oliveOil: 6,
    flour: '麵粉（高筋或中筋）',
    tips: ['室溫發酵：一發 1-2 小時至兩倍大，二發 30-45 分', '冷藏發酵：混合後冷藏 12-24 小時，烤前回溫 30-45 分', '入烤盤後指尖戳洞，淋橄欖油與粗海鹽，預熱 200-220°C 烘烤 20-25 分'] },
};
